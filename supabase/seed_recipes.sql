...
from r, (values
    ...
    ('hop', 'Cascade', 48, null, 'dryhop1', 0, 6),
    ('hop', 'Mosaic', 48, null, 'dryhop1', 0, 7),
    ('hop', 'Simcoe', 16, null, 'dryhop1', 0, 8),
...
from r, (values
    ...
    ('hop', 'Amarillo', 48, null, 'dryhop1', 0, 4),
    ('hop', 'Cascade', 48, null, 'dryhop1', 0, 5),
    ('yeast', 'K97', 1, null, null, null, 0),
...
from r, (values
    ...
    ('hop', 'Cascade', 36, null, 'dryhop1', 0, 4),
...
from r, (values
    ...
    ('hop', 'Cascade', 32, null, 'dryhop1', 0, 2),
    ('hop', 'CTZ', 8, null, 'boil', 20, 3),
    ('hop', 'CTZ', 24, null, 'boil', 5, 4),
    ('hop', 'CTZ', 32, null, 'dryhop1', 0, 5),
...
from r, (values
    ...
    ('hop', 'Centennial', 48, null, 'dryhop1', 0, 7),
    ('hop', 'Chinook', 48, null, 'dryhop1', 0, 8),
    ('yeast', 'K97', 1, null, null, null, 0),
    ('adj', 'Clarity Ferm', 125, 'ml', 'fermentation', 0, 0),
...
from r, (values
    ...
    ('hop', 'Cascade', 32, null, 'dryhop1', 0, 4),
    ('yeast', 'K97', 1, null, null, null, 0),
    ('adj', 'Clarity Ferm', 125, 'ml', 'fermentation', 0, 0)
) as v(category, name, qty, unit, stage, time_min, ord);
...
from r, (values
    ...
    ('hop', 'Amarillo', 12, null, 'whirlpool', 20, 3),
    ('hop', 'Cascade', 12, null, 'whirlpool', 20, 4),
    ('hop', 'Amarillo', 48, null, 'dryhop1', 0, 5),
    ('hop', 'Cascade', 48, null, 'dryhop1', 0, 6),
