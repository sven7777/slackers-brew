...
// Dry hop is numbered because a beer can be charged more than once and each
// charge goes in on its OWN day. Without the number there was nothing to pair a
// hop with a scheduled date, so the Cellar Sheet could only ever print one.
// Three covers double and triple dry hopping; adding a fourth is one entry here
// plus one in `cellarActions`.
export const DRY_HOP_CHARGES = 3;
export const dryHopStages = Array.from({ length: DRY_HOP_CHARGES }, (_, i) => `dryhop${i + 1}`);
export const cellarStages = [...dryHopStages,"primary","secondary","fining","rousing","transfer","keg","bottling"];

// Legacy single-charge values, from before the charges were numbered. Recipes
// carrying them read as charge 1 (migration 0011 rewrites prod; a localStorage
// device or an old backup file still arrives this way).
export const LEGACY_DRY_HOP_STAGE = "dryhop";
export const LEGACY_DRY_HOP_ACTION = "dry hop";

// Which charge a hop stage belongs to: 1-3, or null if it isn't a dry hop.
export const dryHopCharge = (stage) => {
  if (stage === LEGACY_DRY_HOP_STAGE) return 1;
  const m = /^dryhop([1-9])$/.exec(stage ?? "");
  return m ? Number(m[1]) : null;
};

// Display names for stage values that don't read well raw. Anything absent
// shows as-is ("boil", "whirlpool"), which is how the picker has always looked.
export const stageLabels = Object.fromEntries(
  dryHopStages.map((s, i) => [s, `Dry Hop ${i + 1}`])
);
...
export const cellarActions = [
  ...
  "Bung | Pressure","Blow Off","Mini Blow Off","Dry Hop 1","Dry Hop 2","Dry Hop 3","Rouse",
  "Transfer","Carb","Keg",
];

export const defRecipes = [
  {n:"All Y'alls",s:"New England IPA",og:null,fg:null,abv:null,mt:155,m:[["2-Row",185],["White Wheat",55],["Flaked Wheat",35],["Flaked Oat",15]],h:[["Cascade",12,"boil",10],["Amarillo",16,"boil",7.5],["Cascade",12,"boil",5],["Amarillo",12,"whirlpool",20],["Cascade",12,"whirlpool",20],["Chinook",8,"whirlpool",20],["Cascade",48,"dryhop1",0],["Mosaic",48,"dryhop1",0],["Simcoe",16,"dryhop1",0]],y:[["K97",1]],a:[],sa:[["CaCl2",100,"mash"],["CaSo4",40,"mash"],["CaCl2",80,"sparge"],["CaSo4",32,"sparge"]],sc:[[0,"Brew Date"],[11,"Step Crash 55"],[11,"Bung | Pressure"],[12,"Blow Off"],[12,"Dry Hop 1"],[13,"Mini Blow Off"],[13,"Rouse"],[13,"Step Crash 40"],[14,"Blow Off"],[14,"Step Crash 33"],[19,"Blow Off"],[19,"Transfer"],[20,"Blow Off"],[20,"Keg"]]},
  {n:"Beachcomber",s:"Belgian Blond Ale",og:null,fg:null,abv:null,mt:152,m:[["Pils",110],["White Wheat",55],["Vienna",15],["Flaked Wheat",15],["Carafoam",10]],h:[["Amarillo",15,"boil",60],["Crystal",8,"boil",5]],y:[["BE-134",1]],a:[["Candi Syrup",5,"lbs","boil",15]],sa:[]},
  ...
  {n:"Mango Unchained",s:"Double IPA",og:null,fg:null,abv:null,mt:152,m:[["2-Row",330],["Flaked Wheat",20],["Carafoam",20],["Caramunich I",20]],h:[["CTZ",36,"boil",60],["Cascade",10,"boil",10],["Amarillo",12,"whirlpool",15],["Cascade",12,"whirlpool",15],["Amarillo",48,"dryhop1",0],["Cascade",48,"dryhop1",0]],y:[["K97",1]],a:[["Lactose",15,"lbs","boil",5],["Mango Puree",18,"lbs","secondary",0]],sa:[]},
  ...
  {n:"Scarlett",s:"Red IPA",og:null,fg:null,abv:null,mt:154,m:[["2-Row",110],["Maris Otter",110],["Munich",55],["Caramunich I",30],["Roasted Barley",4]],h:[["Chinook",18,"boil",60],["Centennial",18,"boil",15],["Cascade",18,"boil",10],["Centennial",42,"whirlpool",60],["Cascade",36,"dryhop1",0]],y:[["DA-16",1]],a:[],sa:[["CaSo4",68,"mash"],["CaCl2",35,"mash"],["CaSo4",33,"boil"],["CaCl2",18,"boil"]]},
  {n:"Sheriff Bart IPA",s:"Black IPA",og:null,fg:null,abv:null,mt:152,m:[["2-Row",275],["Caramunich I",22],["Midnight Wheat",22],["Chocolate",5]],h:[["CTZ",12,"boil",60],["Chinook",16,"boil",20],["Cascade",32,"dryhop1",0],["CTZ",8,"boil",20],["CTZ",24,"boil",5],["CTZ",32,"dryhop1",0]],y:[["US-05",1]],a:[["Whirlfloc",12,"each","boil",15]],sa:[["CaSo4",48,"mash"],["CaCl2",45,"mash"],["Epsom",28,"mash"],["CaSo4",48,"boil"],["CaCl2",40,"boil"],["Epsom",28,"boil"]]},
  ...
  {n:"Situation IPA",s:"American IPA",og:null,fg:null,abv:null,mt:152,m:[["2-Row",235],["Caramunich I",30],["White Wheat",20],["Carafoam",15],["Aromatic",10],["Roasted Barley",1]],h:[["Chinook",5,"boil",75],["CTZ",20,"boil",60],["Cascade",8,"boil",20],["Chinook",10,"boil",7.5],["Amarillo",12,"boil",5],["Amarillo",12,"whirlpool",15],["Chinook",12,"whirlpool",15],["Centennial",48,"dryhop1",0],["Chinook",48,"dryhop1",0]],y:[["K97",1]],a:[["Clarity Ferm",125,"ml","fermentation",0]],sa:[["CaSo4",58,"mash"],["CaCl2",52,"mash"],["Epsom",34,"mash"],["Lactic Acid",20,"mash"],["CaSo4",54,"boil"],["Chalk",50,"boil"],["CaCl2",48,"boil"],["Epsom",32,"boil"]]},
  {n:"Spruced Up",s:"American Pale Ale",og:null,fg:null,abv:null,mt:152,m:[["2-Row",110],["Pils",110],["Caramunich I",25],["Carafoam",10],["Aromatic",8]],h:[["CTZ",12,"boil",60],["Cascade",24,"boil",15],["Cascade",24,"boil",5],["Cascade",24,"whirlpool",5],["Cascade",32,"dryhop1",0]],y:[["K97",1]],a:[["Clarity Ferm",125,"ml","fermentation",0]],sa:[]},
  ...
  {n:"Wit's End",s:"Witbier",og:null,fg:null,abv:null,mt:152,m:[["Pils",220],["White Wheat",55],["Flaked Wheat",22],["Carafoam",10]],h:[["Cascade",12,"boil",10],["Amarillo",16,"boil",7.5],["Cascade",12,"boil",5],["Amarillo",12,"whirlpool",20],["Cascade",12,"whirlpool",20],["Amarillo",48,"dryhop1",0],["Cascade",48,"dryhop1",0],["CTZ",4,"boil",60]],y:[["BE-256",1]],a:[["Coriander",1,"oz","boil",0],["Orange Peel",1,"oz","boil",0]],sa:[]},
];
...
export const tabNames = ["Inventory", "Recipes", "Order Calculator", "Analytics", "Settings"];
